  ...
  private categorias: Categoria[] = [
    {
      id: randomUUID(),
      nome: 'Elétrica',
      descricao: 'Problemas elétricos em geral',
      criadoEm: new Date(),
    },
    {
      id: randomUUID(),
      nome: 'Hidráulica',
      descricao: 'Vazamentos e entupimentos',
      criadoEm: new Date(),
    },
    {
      id: randomUUID(),
      nome: 'Estrutural',
      descricao: 'Problemas em paredes, pisos e tetos',
      criadoEm: new Date(),
    },
    {
      id: randomUUID(),
    ...
    },
    {
      id: randomUUID(),
      nome: 'Informática',
      descricao: 'Computadores, rede e equipamentos de TI',
      criadoEm: new Date(),
    },
    {
      id: randomUUID(),
      nome: 'Mobiliário',
      descricao: 'Cadeiras, mesas e armários',
      criadoEm: new Date(),
    },
  ];
